...
let form, hidden, mainTag, svg;
function globals() {
    form = document.querySelector(`#offer-section form`);
...
const readyFunctions = [banner, bannerBg, jobDescription, structure, navStructure, applicationForm, applicationFormFileInputs, applicationFormOtherInputs, sideBox];

function main() {
    // console.log(`Success`);
    mainTag.classList.add(`sp-dev-css__ready-1`);
